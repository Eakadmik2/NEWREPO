...
urlpatterns = [
    ...
    path('send_notification_student', HodViews.send_notification_student,
         name="send_notification_student"),
    path('send_notification_staff', HodViews.send_notification_staff,
    ...
    path('save_attendance_data', StaffViews.save_attendace_data,
         name="save_attendace_data"),
